    ...
    const load = async () => {
      try {
        ...
        setStats({
          ...
          totalPlantas: (plantas || []).reduce(
            (s, p) => s + (Number(p.stock || p.cantidad) || 0),
            0,
          ),
              ...
              <CardActionArea onClick={() => navigate(c.path)}>
                ...
                <CardContent sx={{ p: 3 }}>
                  ...
                  >
                    {c.sub}{" "}
                    <ArrowForwardIos
                      sx={{ fontSize: 10, color: "text.disabled", ml: "auto" }}
                    />
                  </Typography>
                </CardContent>
              </CardActionArea>
        ...
        <Grid item xs={12} md={8}>
          ...
          <Paper sx={{ p: 3, borderRadius: 3, boxShadow: 1 }}>
            <Box sx={{ display: "flex", alignItems: "center", gap: 1, mb: 2 }}>
              ...
              <Typography variant="h6" fontWeight={600}>
                Últimos Fertilizantes Agregados
              </Typography>
            </Box>
            <TableContainer>
              <Table size="small">
                <TableHead>
                  ...
                  >
                    ...
                    <TableCell align="right">Cantidad (kg/l)</TableCell>
                  ...
                  {recientesAbonos.length === 0 && (
                    <TableRow>
                      <TableCell colSpan={4} align="center">
                        No hay fertilizantes registrados aún
                      </TableCell>
                    </TableRow>
                  )}
                </TableBody>
            ...
            <List>
              {recientesPlantas.map((planta, index) => (
                <Box key={planta.id || index}>
                  ...
                  {index < recientesPlantas.length - 1 && (
